...
import in.novopay.platform_ui.pages.mobile.RBLAEPSStatusEnquiryPage;
...
public class RBLAEPSStatusEnquiryTest {
	...
	public String sheetname = "RBLAEPSStatusEnquiryPage", workbook = "MobileAppUITestData";
	...
	public void rBLAEPSStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wRBLAEPSStatusEnquiryPage = new RBLAEPSStatusEnquiryPage(mdriver);
