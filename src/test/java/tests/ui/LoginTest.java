...
import in.novopay.platform_ui.pages.mobile.LoginPage;
...
public class LoginTest {
	...
	public String sheetname = "LoginPage", workbook = "MobileAppUITestData";
	...
	@Test
	public void loginTest(HashMap<String, String> usrData) throws Exception {
	 ...
	 * 
	 * if (mdriver != null) { mBasePage.closeApp(); } }
	 */
	...
	/*
	 * @AfterMethod public void result(ITestResult result) throws
	 * InvalidFormatException, IOException {
	 * 
	 * String failureReason = "";
	 * 
	 * if (!result.isSuccess()) { failureReason = result.getThrowable() + ""; }
	 * String[] execeutionDtls = { JavaUtils.configProperties.get("buildNumber"),
	 * featureName, usrData.get("TCID"), usrData.get("DESCRIPTION"),
	 * javaUtils.getExecutionResultStatus(result.getStatus()), failureReason };
	 * javaUtils.writeExecutionStatusToExcel(execeutionDtls); if
	 * (!result.isSuccess()) { System.exit(0); } }
	 */
}
