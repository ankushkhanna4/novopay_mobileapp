...
import in.novopay.platform_ui.pages.mobile.RBLBankingPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;
import io.appium.java_client.MobileElement;
import io.appium.java_client.android.AndroidDriver;

public class RBLBankingTest {
	String featureName = "RBL Banking page";
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(mdriver);
	private RBLBankingPage mRBLBankingPage;
	private Map<String, String> usrData;
	public String sheetname = "RBLBankingPage", workbook = "MobileAppUITestData";
	...
	public void rBLBankingTest(HashMap<String, String> usrData)
		...
		mRBLBankingPage = new RBLBankingPage(mdriver);
		mRBLBankingPage.rblBanking(usrData);
	}
