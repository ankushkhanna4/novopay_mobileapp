...
import in.novopay.platform_ui.pages.mobile.FullertonPage;
...
public class FullertonTest {
	...
	public String sheetname = "FullertonPage", workbook="MobileAppUITestData";
	...
	public void fullertonTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, IOException, ClassNotFoundException{
		...
		wFullertonPage = new FullertonPage(mdriver);
