...
import in.novopay.platform_ui.pages.mobile.SwiggyPage;
...
public class SwiggyTest {
	...
	private SwiggyPage mSwiggyPage;
	private Map<String, String> usrData;
	public String sheetname = "SwiggyPage", workbook = "MobileAppUITestData";
	...
	public void swiggyTest(HashMap<String, String> usrData)
		...
		mSwiggyPage = new SwiggyPage(mdriver);
		mSwiggyPage.swiggy(usrData);
	}
