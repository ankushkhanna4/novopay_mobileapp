...
import in.novopay.platform_ui.pages.mobile.EnvPage;
...
public class EnvTest {
	...
	public void envTest(HashMap<String, String> usrData) throws ClassNotFoundException {
		...
		mEnvPage = new EnvPage();
		mEnvPage.env(usrData);
	}
