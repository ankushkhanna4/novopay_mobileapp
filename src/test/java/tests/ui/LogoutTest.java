...
import in.novopay.platform_ui.pages.mobile.LogoutPage;
...
public class LogoutTest {
	...
	public String sheetname = "LogoutPage", workbook = "MobileAppUITestData";
	...
	public void logoutTest(HashMap<String, String> usrData) throws AWTException, InterruptedException {
		...
		mLogoutPage = new LogoutPage(mdriver);
		mLogoutPage.logout(usrData);
	}
