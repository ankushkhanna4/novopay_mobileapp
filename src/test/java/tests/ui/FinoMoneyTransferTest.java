...
import in.novopay.platform_ui.pages.mobile.FinoMoneyTransferPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;
import io.appium.java_client.MobileElement;
import io.appium.java_client.android.AndroidDriver;

public class FinoMoneyTransferTest {
	String featureName = "Fino Money Transfer page";
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(mdriver);
	private FinoMoneyTransferPage mFinoMoneyTransferPage;
	private Map<String, String> usrData;
	public String sheetname = "FinoMoneyTransferPage", workbook = "MobileAppUITestData";
	...
	public void finoMoneyTransferTest(HashMap<String, String> usrData)
			throws Throwable {
		...
		mFinoMoneyTransferPage = new FinoMoneyTransferPage(mdriver);
		mFinoMoneyTransferPage.finoMoneyTransfer(usrData);
	}
