...
import in.novopay.platform_ui.pages.mobile.CapitalFirstPage;
...
public class CapitalFirstTest {
	String featureName = "Capital First page";
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private CapitalFirstPage wCapitalFirstPage;
	private Map<String, String> usrData;
	public String sheetname = "CapitalFirstPage", workbook="MobileAppUITestData";
	...
	public void capitalFirstTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, IOException, ClassNotFoundException{
		...
		wCapitalFirstPage = new CapitalFirstPage(mdriver);
		wCapitalFirstPage.capitalFirst(usrData);
	}
