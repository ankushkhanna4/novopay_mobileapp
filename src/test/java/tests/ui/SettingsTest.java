...
import in.novopay.platform_ui.pages.mobile.SettingsPage;
...
public class SettingsTest {
	...
	public void settingsTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, IOException, ClassNotFoundException{
