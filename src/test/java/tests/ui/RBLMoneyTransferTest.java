...
import in.novopay.platform_ui.pages.mobile.RBLMoneyTransferPage;
...
public class RBLMoneyTransferTest {
	...
	private RBLMoneyTransferPage mRBLMoneyTransferPage;
	private Map<String, String> usrData;
	public String sheetname = "RBLMoneyTransferPage", workbook = "MobileAppUITestData";
	...
	public void rBLMoneyTransferTest(HashMap<String, String> usrData)
		...
		mRBLMoneyTransferPage = new RBLMoneyTransferPage(mdriver);
		mRBLMoneyTransferPage.rblMoneyTransfer(usrData);
	}
