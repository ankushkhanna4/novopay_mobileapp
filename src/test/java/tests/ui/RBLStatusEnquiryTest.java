...
import in.novopay.platform_ui.pages.mobile.RBLStatusEnquiryPage;
...
public class RBLStatusEnquiryTest {
	String featureName = "RBL Status Enquiry page";
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(mdriver);
	private RBLStatusEnquiryPage mRBLStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "RBLStatusEnquiryPage", workbook="MobileAppUITestData";
	...
	public void rBLStatusEnquiryTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, IOException, ClassNotFoundException{
		...
		mRBLStatusEnquiryPage = new RBLStatusEnquiryPage(mdriver);
		mRBLStatusEnquiryPage.rBLStatusEnquiry(usrData);
	}
